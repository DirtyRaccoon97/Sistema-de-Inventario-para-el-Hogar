...
export const PantryIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M20 10v10H4V10" />
    <path d="M20 8v2H4V8" />
    <path d="M18 4h-2a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2H4a1 1 0 0 0-1 1v3h18V5a1 1 0 0 0-1-1z" />
    <path d="M6 14h12" />
    <path d="M6 18h12" />
  </svg>
);
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2L9.8 8.2 4 10l5.8 5.8L8.2 22 12 18l3.8 4-1.6-6.2L20 10l-5.8-1.8z"/>
        <path d="M22 12l-2-1-1-2-1 2-2 1 2 1 1 2 1-2 2-1zM4 2l2 1 1 2 1-2 2-1-2-1-1-2-1 2-2-1z"/>
    </svg>
);
